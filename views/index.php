...
// Read Slider Data from Database
  $slider_sql = "SELECT * FROM slider WHERE status = '1' AND page = 'home' ORDER BY sid DESC";
...
// Read Banner Data from Database
  ...
  $banner_resault = mysqli_query($conn, $banner_sql);
  while ($row = mysqli_fetch_assoc($banner_resault)) {
    switch ($row['bid']) {
      case 1:
        $b1_title = $row['title'];
        $b1_text = $row['text'];
...
// $products = json_decode(file_get_contents('https://fakestoreapi.com/products?sort=desc&limit=8'), true);
$product_sql = "SELECT * FROM product WHERE status = 1 ORDER BY pid DESC LIMIT 8";
$product_resault = mysqli_query($conn, $product_sql);
$products = mysqli_fetch_all($product_resault, MYSQLI_ASSOC);
...
<body>
  ...
  <div class="slider_container">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
      <div class="carousel-inner">
        <?php foreach ($slider_rows as $index => $slider) : ?>
            ...
            <div class="row">
              <div class="col-md-7 text">
                <div class="detail-box">
                  ...
                  <p><?= nl2br($slider['text']) ?></p>
                  <a href="<?= $slider['btn_url'] ?>"><?= $slider['btn_text'] ?></a>
                </div>
              </div>
    ...
    <div class="box">
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-6">
            <div class="img-box">
              <img src="images/banner/saving-img.png" alt="">
            </div>
          </div>
          <div class="col-lg-6">
            <div class="detail-box">
              <div class="heading_container">
                <h2>
                  <?= nl2br($b1_title) ?: $b1_title ?>
                </h2>
              </div>
              <p>
                <?= nl2br($b1_text) ?: $b1_text ?>
              </p>
              <div class="btn-box">
                <a href="<?= $b1_btn1_link ?>" class="btn1">
                  <?= $b1_btn1_text ?>
                </a>
                <a href="<?= $b1_btn2_link ?>" class="btn2">
                  <?= $b1_btn2_text ?>
                </a>
              </div>
            </div>
  ...
  <section id="why-us" class="why_section layout_padding">
    <div class="container">
      <div class="heading_container heading_center">
        <h2>
          Why Shop With Us
  ...
  <section class="gift_section layout_padding-bottom">
    <div class="box" style="background-color: <?= $b2_color ?>">
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-5">
            <div class="img_container">
              <div class="img-box">
                <img src="<?= $b2_image ?>" alt="">
              </div>
            </div>
          </div>
          <div class="col-md-7">
            <div class="detail-box">
              <div class="heading_container">
                <h2>
                  <?= nl2br($b2_title) ?: $b2_title ?>
                </h2>
              </div>
              <p>
                <?= nl2br($b2_text) ?: $b2_text ?>
              </p>
              <div class="btn-box">
                <a href="<?= $b2_btn1_link ?>" class="btn1">
                  <?= $b2_btn1_text ?>
                </a>
                <a href="<?= $b2_btn2_link ?>" class="btn2">
                  <?= $b2_btn2_text ?>
                </a>
              </div>
            </div>
  ...
  <section id="contact-us" class="contact_section ">
        ...
        <div class="col-lg-7 col-md-6 px-0">
          <div class="map_container">
            <div class="map-responsive">
              <iframe src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&q=<?= $map_lat . ',' . $map_long ?>" width="600" height="300" frameborder="0" style="border:0; width: 100%; height:100%" allowfullscreen></iframe>
            </div>
          </div>
        </div>
  ...
  <!-- back to top button -->
  <a id="back-to-top" href="#" class="btn btn-light btn-lg back-to-top" role="button" aria-label="Scroll to top"><i class="fas fa-chevron-up"></i></a>
